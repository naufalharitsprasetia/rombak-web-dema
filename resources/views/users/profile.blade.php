                                ...
                                <div class="p-5">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-5 w-0 flex-1">
                                            <dl>
                                                <dt
                                                    class="text-sm font-medium text-demamuda dark:text-gray-400 truncate">
                                                    Points
                                                </dt>
                                                <dd id="points"
                                    ...
                                    <div class="mt-4">
                                        <div class="relative pt-1">
                                            ...
                                            <div class="flex justify-between">
                                                <div class="text-sm font-medium text-demamuda dark:text-gray-400">
                                                    Points
                                                    Sekarang
                                                </div>
                                                <div class="text-sm font-medium text-demamuda dark:text-gray-400">Butuh
                                                    Points
                                                </div>
                                            </div>
