        ...
        <main class="w-full bg-white dark:bg-zinc-900">
            <div class="mx-auto py-6 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-demamuda/20 text-demamuda dark:bg-demamuda/30 dark:text-demamuda">Didukung
                        oleh AI ✨</span>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                    ...
                    <div class="overflow-hidden shadow-sm rounded-lg border dark:border-zinc-600">
                        ...
                        <div class="bg-gray-200 dark:bg-zinc-700 px-5 py-3">
                            <div class="text-sm">
                                <a href="#userBadge" class="font-medium text-green-600 hover:text-demamuda">Lihat
                                    detail</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-hidden shadow-sm rounded-lg border dark:border-zinc-600">
                        ...
                        <div class="bg-gray-200 dark:bg-zinc-700 px-5 py-3">
                            <div class="text-sm">
                                ...
                                <a href="#quizHistory" class="font-medium text-green-600 hover:text-demamuda">Lihat
                                    detail</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-5">
                            <div class="flex justify-between items-center">
                                <div class="text-sm font-medium text-demamuda dark:text-gray-400">Points needed =>
                                    Next
                                    Tier
                                </div>
                                ...
                                <div class="relative pt-1">
                                    <div
                                        ...
                                        <div style="width: {{ $persen }}%"
                                            class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-demamuda">
                                        </div>
                                    </div>
                                    <div class="flex justify-between">
                                        <div class="text-sm font-medium text-demamuda dark:text-gray-400">Points
                                            Sekarang
                                        </div>
                                        <div class="text-sm font-medium text-demamuda dark:text-gray-400">Butuh Points
                                        </div>
                                    </div>
                ...
                <div class="user-badges flex flex-wrap gap-3 justify-center items-center mb-4">
                    ...
                    <div class="max-w-lg rounded-lg border-2 border-demamuda p-3 flex justify-center items-center">
