        ...
        <main class="w-full">
            <div class="mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <a href="{{ route('divisi.index') }}" class="mb-4 p-2 text-sm text-dematua hover:text-demamuda">
                    <- Kembali</a>
                        <h2 class="text-2xl font-semibold text-zinc-900 dark:text-white">Edit Divisi</h2>
                        <br>
                        {{-- Form Create --}}
                        <section class="bg-white dark:bg-gray-900">
                            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Divisi</h2>
                                {{-- form --}}
                                <form action="{{ route('divisi.edit',$division->id) }}" method="post"
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            ...
                                            <input type="text" name="nama" id="nama"
                                                ...
                                                placeholder="Nama Divisi.." value="{{ old('nama',$division->nama) }}"
                                                required>
                                        </div>
