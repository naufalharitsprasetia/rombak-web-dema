        ...
        <main class="w-full">
            <div class="mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <a href="{{ route('departement.manage') }}" class="mb-4 p-2 text-sm text-dematua hover:text-demamuda">
                    <- Kembali</a>
                        <h2 class="text-2xl font-semibold text-zinc-900 dark:text-white">Edit Anggota Departement</h2>
                        <br>
                        {{-- Form Create --}}
                        <section class="bg-white dark:bg-gray-900">
                            <div class="py-6 px-4 mx-auto max-w-2xl">
                                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Update Anggota
                                    Departement
                                </h2>
                                {{-- form --}}
                                <form action="{{ route('anggota_departement.update',$anggotaDepartement->id) }}"
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            ...
                                            <input type="text" name="nim" id="nim"
                                                ...
                                                value="{{ old('nim', $anggotaDepartement->nim) }}" required>
                                        </div>
                                        <div class="sm:col-span-2">
                                            <label for="nama"
                                            ...
                                            <input type="text" name="nama" id="nama"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Nama.."
                                                value="{{ old('nama', $anggotaDepartement->nama) }}" required>
                                        </div>
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <select id="departement_id" name="departement_id" required
                                                ...
                                                <option value="{{ $departement->id }}" {{ $anggotaDepartement->
                                                    departement->id == $departement->id ? 'selected' : '' }}>{{
                                                    $departement->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <input type="number" name="urutan" id="urutan"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Urutan..."
                                                value="{{ old('urutan', $anggotaDepartement->urutan) }}" required>
                                        </div>
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <input type="text" name="prodi" id="prodi"
                                                ...
                                                value="{{ old('prodi', $anggotaDepartement->prodi) }}" required>
                                        </div>
                                        <div class="sm:col-span-2">
                                            <label for="asal"
                                            ...
                                            <input type="text" name="asal" id="asal"
                                                ...
                                                value="{{ old('asal', $anggotaDepartement->asal) }}">
                                        </div>
                                    </div>
                                    <button type="submit"
