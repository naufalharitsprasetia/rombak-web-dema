                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    ...
                    <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                        <div class="relative group cursor-pointer">
                            ...
                            <div
                                class="relative leading-none items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 ring-1 ring-gray-900/5">
                                <a href="#">
                        ...
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Lana drives the
                                    technical
                                    strategy of the flowbite platform and brand.</p>
                                <ul class="flex space-x-4 sm:mt-0">
                                    <li>
