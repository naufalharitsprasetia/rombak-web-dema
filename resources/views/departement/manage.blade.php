    ...
    <div class="flex flex-col w-full">
        <main class="w-full">
            <div class="mx-auto py-6 sm:px-6 lg:px-8">
                <!-- Isi Halaman -->
                <h2 class="text-2xl font-semibold text-zinc-900 dark:text-white">List Departement</h2>
                <p class="text-sm text-zinc-900 dark:text-white">Total Departements : {{ count($departements) }}</p>
