...
<div class="mx-6 md:mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <div class="showing-total mb-4">
        {{-- <p class="text-base font-semibold">Total Artikels : {{ $departements->total() }}</p> --}}
        <p class="text-base font-semibold">Total Departement : {{ count($departements) }}</p>
    </div>
    <!-- Table -->
        ...
        <table class="min-w-full text-sm md:text-base bg-white border border-gray-300">
            <thead>
                <tr class="text-left">
                    ...
                    <th class="py-2 px-4 border-b border-r">Departement</th>
                    <th class="py-2 md:px-4 border-b border-r text-center">Divisi</th>
            ...
            <tbody id="divisi-table-body">
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border-b border-r">
                        {{ $departement->division->nama }}
                    </td>
                    <td class="py-2 px-4 border-b border-r">
                        {{ $departement->urutan }}
                    </td>
                    <td class="py-2 px-4 border-b border-r">
                        {{ $departement->singkatan }}
                    </td>
                    <td class="py-2 px-4 border-b border-r">
                    ...
                    <td class="py-2 px-4 border-b border-r ">
                        <div class="flex">
                            ...
                            <form action="/departement-delete/{{ $departement->id }}" method="POST" class="inline-block"
