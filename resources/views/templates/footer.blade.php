        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 ">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-bold text-zinc-900 dark:text-white">Dewan<span
                            class="text-demamuda">Mahasiswa</span></span>
                </div>
                <div class="flex space-x-4">
                    ...
                    <a href="https://www.youtube.com/@gontortv" target="_blank"
                        class="text-gray-400 hover:text-gray-500">
                    ...
                    <a class="text-gray-400 hover:text-gray-500" target="_blank"
                        href="https://www.linkedin.com/school/universitas-darussalam-gontor/">
